...
#
##%%
#def _profiler_gpu(bs = 50, img_s = 200):
#    # Setup transformer
...
#
##%%
#def _transformer_speed_test(bs = 50, img_s = 200, rep = 1, 
...
#
##%%
#def _new_transformer_speed_test(bs = 50, img_s = 200, rep = 1,
#                               ncx = 2, ncy = 2, device = '/gpu:0'):
#    
#    # Setup transformer
#    s = setup_CPAB_transformer(ncx=ncx, 
...
#               
##%%
#def _gradient_speed_test(bs = 50, img_s = 200, rep = 1,
#                        ncx = 2, ncy = 2, device = '/gpu:0'):
#    # Setup transformer
#    s = setup_CPAB_transformer(ncx=ncx, 
#                               ncy=ncy,
